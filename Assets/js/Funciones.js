        ...
        $.ajax({
            ...
            success: function (response) {
                if (response != 0) {
                    ...
                    document.getElementById("precioc").value = info.precioc;
                    $("#stockD").val(info.cantidad);
                    document.getElementById("cantidad").value = 1;
                    document.getElementById("nombreP").innerHTML = info.nombre;
                    document.getElementById("precioP").innerHTML = info.precioc;
...
function IngresarCantidad(e) {
    ...
    if (e.which == 13) {
        if (stockD == "") {
            ...
            $("#buscar_codigo").focus();
            document.getElementById("nombreprecioPP").innerHTML = "";
