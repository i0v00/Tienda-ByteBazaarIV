                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="ruc" class="form-control" type="text" name="ruc" placeholder="CI/Carnet">
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="extci">Extencion CI</label>
                                <select id="extci" class="form-control" name="extci">
