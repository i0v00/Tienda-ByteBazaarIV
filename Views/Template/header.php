            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong style="color: #EE466C;">ByteB </strong><strong style="color: #76F85B;">Bazaar</strong><strong style="color: #5FC7F1;">IV </strong></div>
                        <div class="brand-text brand-sm"><strong style="color: #EE466C;">J</strong><strong style="color: #76F85B;">I</strong><strong style="color: #5FC7F1;">V</strong></div>
                    </a>
                    <!-- Sidebar Toggle Btn-->
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    ...
                    <h4><strong style="color: #AC3BF0;"><?php echo date("d-M-Y") ?></strong>
                </div>
                <!-- Log out               -->
