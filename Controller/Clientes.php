<?php
    ...
    public function eliminados()
    {
        ...
        public function insertar()
        {
            ...
            $insert = $this->model->insertarClientes($ruc, $extci, $nombre,$telefono, $direccion, $membresia);
            if ($insert > 0) {
            $alert = 'registrado';
    ...
    public function actualizar()
    {
        ...
        $direccion = $_POST['direccion'];
        $membresia = $_POST['membresia'];
        $actualizar = $this->model->actualizarClientes($ruc, $extci, $nombre, $telefono, $direccion, $membresia, $id);
        if ($actualizar == 1) {
            $alert = 'modificado';
        }else {
            $alert = 'error';
